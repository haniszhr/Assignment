...
<div> <center><img src="image/add-document.png" width="40%"></center></br></br><a href="adddoc.php"><input type="button" value="ADD DOCUMENT" class="button"></a></div>
    ...
    <div style="margin-left:100px" > <center><img src="image/pay.png" width="100%"></center></br></br></br></br></br></br></br><a href="custpay1.php"><input type="button" value="PAYMENT" class="button"></a></div>
