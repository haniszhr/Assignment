...
$sql= "SELECT customer.Cust_Name,files.FileID,files.File_Name,files.Payment_Status,files.Page,files.Date,files.Color,files.Price FROM files inner join customer where customer.CustID=files.CustID";
...
if($result->num_rows > 0) {
    ...
    while($row = $result->fetch_assoc()) {
        ...
        ?>
         <td align="center"><a href="updatepaymentstafffinal.php?id=<?php echo $row["FileID"]; ?> " class="button">UPDATE TOTAL PAGE</a></td>
