...
$sql="SELECT files.FileID,files.File_Name,files.Service_Type,files.Date,files.Payment_Status,files.Status_Order FROM files INNER JOIN customer ON files.CustID=customer.CustID where files.CustID={$_SESSION['cid']}";
