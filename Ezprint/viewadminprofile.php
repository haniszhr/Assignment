...
if($result->num_rows>0)
{
    while($row=$result->fetch_assoc()){
        ...
        echo "<form method ='post' action='updateadminprofile.php'>";

        echo"<tr><td align = 'left'><b style='font-size: 25px;color:white;'>ID:</b></td><td align='left' style='font-size: 25px;color:black;background-color:rgb(240, 245, 173);padding:10px'>".$row['StaffID']."</td></tr>";
        ...
        echo"  <tr><td  align = 'left'><b style='font-size: 25px;color:white;'>EMAIL</td><td align='left' style='font-size: 25px;color:black;background-color:rgb(240, 245, 173);padding:10px'>".$row['Staff_Email']."</td></tr>";
        echo"  <tr><td align = 'left'><b style='font-size: 25px; color:white;'>PASSWORD</b></td><td align='left' style='font-size: 25px;color:black;background-color:rgb(240, 245, 173);padding:10px'>".$row['Staff_Password']."</td></tr>";
