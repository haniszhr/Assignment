...
$sql="UPDATE staff set Staff_Name='".$name."',  Staff_Phone='".$phone."', Staff_Address='".$address."'where Staff_Email='$semail' and Staff_Password='$spsw'";
$result=$conn->query($sql);
if($conn->query($sql)===TRUE)
{

  $sql="SELECT * FROM staff where Staff_Email='$semail' and Staff_Password='$spsw'";
  $result=$conn->query($sql);
