...
while($row = $result ->fetch_assoc()) {
    ...
    if($row['Payment_Status'] == "Unpaid"){
        ...
        if($row['Status_Order'] == "In progress"){
            ...
            <input type='radio' name='Status_Progress' value='Ready to pickup'>Ready to pickup
            <input type='radio' name='Status_Progress' value='On delivery'>On delivery
            <input type='radio' name='Status_Progress' value='Completed'>Completed</td></tr>";}
                ...
                <input type='radio' name='Status_Progress' value='Ready to pickup' checked>Ready to pickup
                <input type='radio' name='Status_Progress' value='On delivery'>On delivery
                <input type='radio' name='Status_Progress' value='Completed'>Completed</td></tr>";}
                    ...
                    echo "<tr><th>Status Order: </th><td><input type='radio' name='Status_Order' value='In progress'>In progress
                    <input type='radio' name='Status_Progress' value='Ready to pickup' >Ready to pickup
                    <input type='radio' name='Status_Progress' value='On delivery' checked>On delivery
                    <input type='radio' name='Status_Progress' value='Completed'>Completed</td></tr>";}
