...
<section>
	<article>
        <center>
		<h1 style="color: white; font-size: 70px;">CUSTOMER LOGIN</h1></center>
        ...
        <center>
         ...
         <form action="custlogin2.php" method="post">
            ...
            <tr>
             ...
             <input size="50" type="email" placeholder="Enter Email" name="c_email" required style="padding: 10px;"></td>
            </tr>
            
            <tr>
            <td align = "left"><b style="font-size: 25px; color:white;">PASSWORD</b></td>
            <td  colspan="5"align = "left">
                <input size="50" type="password" placeholder="Enter Password" name="c_psw" required style="padding: 10px;"></td>
            </tr>
           
    </table>
     <p style="color:white">Don't have an account yet?<a href="Registercust.php" style="color:black">Click here</a></p>
</br>
